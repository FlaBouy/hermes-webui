...
- Biggy LaunchAgent: `ai.biggy.webui`; active listener PID was 62523.
- A second orphaned `server.py` process (PID 62445 at the check) existed but did not own port 8790. Diagnose before terminating; do not assume it is safe merely because it is not listening.
