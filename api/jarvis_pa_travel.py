...
def plan_trip(*, origin: str, destination: str) -> dict[str, Any]:
    ...
    return {"ok": True, "schema": "jarvis.pa.trip_plan.v1", "source": _SOURCE, "origin": origin_place, "destination": destination_place, "map_view_model": map_view_model, "recommendation_view_models": models, "notice": "Read-only planning evidence. Jarvis cannot book, purchase, reserve, or verify live availability."}
