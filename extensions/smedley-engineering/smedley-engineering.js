(() => {
  ...
  function makeRightRail(){
    ...
    function renderQueue(status){
      ...
      const rows=status&&(status.queue||status.focus)||[];
      if(!box) return;
